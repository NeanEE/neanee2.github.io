...
tcs_c_cian.addEventListener("click", ()=>{
    ...
    body_menu.classList.remove("teme--btn-aqua", "teme--btn-malaquita", "teme--btn-malva", "teme--btn-coral");
...
tcs_c_aqua.addEventListener("click", ()=>{
    ...
    body_menu.classList.remove("teme--btn-cian", "teme--btn-malaquita", "teme--btn-malva", "teme--btn-coral");
...
tcs_c_malaquita.addEventListener("click", ()=>{
    ...
    body_menu.classList.remove("teme--btn-cian", "teme--btn-aqua", "teme--btn-malva", "teme--btn-coral");
...
tcs_c_malva.addEventListener("click", ()=>{
    ...
    body_menu.classList.remove("teme--btn-cian", "teme--btn-aqua", "teme--btn-malaquita", "teme--btn-coral");
  ...
  tcs_c_coral.addEventListener("click", ()=>{
    ...
    body_menu.classList.remove("teme--btn-cian", "teme--btn-aqua", "teme--btn-malaquita", "teme--btn-malva");
